...
export default function TasksStatsChart({ tasks, title, isLoading, error }: TasksStatsChartProps) {
    ...
    const completedAngle = taskStats.total > 0 ? (taskStats.completed / taskStats.total) * 360 : 0;
    const overdueAngle = taskStats.total > 0 ? (taskStats.overdue / taskStats.total) * 360 : 0;
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between flex-wrap">
                ...
                {/* Статистика */}
                <div className="flex-1 md:ml-8 space-y-4 w-full md:w-auto max-w-md md:max-w-none">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3 min-w-0 flex-1">
                            <div className="w-4 h-4 bg-green-500 rounded flex-shrink-0"></div>
                            <span className="text-sm text-gray-700 dark:text-gray-200 truncate">Выполнено</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3 min-w-0 flex-1">
                            ...
                            <span className="text-sm text-gray-700 dark:text-gray-200 truncate">Просрочено</span>
                        </div>
                        <div className="text-right flex-shrink-0 ml-2">
                            <span className="text-lg font-semibold text-gray-900 dark:text-white">
                                {taskStats.overdue}
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3 min-w-0 flex-1">
                            ...
                            <span className="text-sm text-gray-700 dark:text-gray-200 truncate">В процессе</span>
                        </div>
                        <div className="text-right flex-shrink-0 ml-2">
                            <span className="text-lg font-semibold text-gray-900 dark:text-white">
